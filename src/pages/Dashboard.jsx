  ...
  return (
    ...
    <div className="bg-gray-200">
      ...
      <div className="flex justify-center w-full bg-gray-200 px-4">
        <div className="mt-10 max-w-[881px] w-full mb-6">
        ...
        <div className="flex justify-center flex-wrap gap-5 mt-5">
          {loading ? (
            ...
            blogsArray.map((blog, index) => (
              <div
                key={blog.docId}
                className="border border-gray-200 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300"
                style={{ width: "881px" }}
              >
